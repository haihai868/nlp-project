...
** Sử dụng với notebook VLSP `nlp-transformer-VLSP-v1-v2010c3d9978.ipynb` (EN-VI), `nlp-transformer-v1-v2__VI-EN.ipynb`(VI-EN)  **
...
- Chạy các file preprocess tương ứng cho 2 bài toán rồi chạy các cell `transformer.ipynb`, `nlp-transformer-VLSP-v1-v2010c3d9978.ipynb`, `nlp-transformer-v1-v2__VI-EN.ipynb` lần lượt.
